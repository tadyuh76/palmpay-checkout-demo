...
export const catalog: Product[] = [
  ...
  },
  {
    ...
    detail: "Espresso, chocolate, đá xay, kem tươi",
    detailI18n: {
      vi: "Espresso, chocolate, đá xay, kem tươi",
    ...
    tags: ["mocha", "đá xay", "espresso"],
    tagsI18n: {
      vi: ["mocha", "đá xay", "espresso"],
      en: ["mocha", "blended", "espresso"],
    },
  },
  {
    ...
    detail: "Cà phê phin, sữa đặc, đá",
    detailI18n: {
      vi: "Cà phê phin, sữa đặc, đá",
      en: "Phin coffee, condensed milk, ice",
    },
    category: "Iced Coffee",
    priceCents: 39000,
  ...
  },
  {
    ...
    detail: "Espresso, sữa tươi, caramel, đá",
    detailI18n: {
      vi: "Espresso, sữa tươi, caramel, đá",
      en: "Espresso, fresh milk, caramel, ice",
    },
    category: "Iced Coffee",
    priceCents: 54000,
    ...
    tags: ["macchiato", "caramel", "cà phê đá"],
    tagsI18n: {
      vi: ["macchiato", "caramel", "cà phê đá"],
      en: ["macchiato", "caramel", "iced"],
    },
  },
  {
    id: "espresso-tonic",
